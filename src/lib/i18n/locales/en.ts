...
const en = {
  ...
  styles: {
    ...
    level: 'Level',
    levelKind: { bullet: 'Bullet', number: 'Number' },
  ...
  toolbarExpanded: {
    ...
    margins: { top: 'Top', bottom: 'Bottom', left: 'Left', right: 'Right', inner: 'Inner', outer: 'Outer' },
    ...
    mirrorMarginsHint: 'Swap the left and right margin on even pages, so the inner one faces the binding',
  ...
  textBox: {
    ...
    vAlignMiddle: 'Align text middle',
  ...
  table: {
    ...
    sortDirection: 'Order',
    sortType: 'Sort type',
    sortTypeAuto: 'Automatic',
    sortTypeNumber: 'Numerically',
    sortTypeText: 'Alphanumerically',
  ...
  findReplace: {
    ...
    format: 'Search and replace formatting',
    formatFind: 'Find:',
  ...
  templates: {
    ...
    letter: {
      ...
      recipientStreet: 'Street and number',
      recipientCity: 'Postal code City',
      yourRef: 'Your reference: ',
      yourMessage: 'Your message of: ',
    ...
    coverLetter: {
      name: 'Cover letter',
      description: 'Job application on the letter geometry: sender block, subject with the position, three body paragraphs, enclosures line.',
      phone: 'Phone number',
      email: 'Email address',
      subject: 'Application for the position of ',
      position: 'Job title',
      subjectRef: 'Your job advertisement of ',
      intro: 'Opening: why you are applying',
      main: 'Main part: experience and strengths',
      final: 'Closing: availability and interview request',
      enclosuresLabel: 'Enclosures: ',
      enclosures: 'CV, certificates',
    },
    cv: {
      name: 'CV',
      description: 'Tabular CV: contact line, experience, education and skills in a two-column tab layout, place, date and signature.',
      phone: 'Phone number',
      email: 'Email address',
      ...
      roleDetail: 'Responsibilities and achievements',
      degree: 'Degree',
      school: 'Institution, city',
      languages: 'Languages',
      languagesValue: 'Language (level)',
      it: 'IT skills',
      itValue: 'Programs and proficiency',
    },
    invoice: {
      name: 'Invoice',
      description: 'Invoice on the business-letter geometry: item table with totals rows, payment terms, bank details.',
      number: 'Number',
      invoiceNo: 'Invoice no.: ',
      customerNo: 'Customer no.: ',
      subject: 'Invoice no. ',
      intro: 'we invoice you for the following services:',
      colPos: 'Item',
      colDescription: 'Description',
      colQty: 'Qty',
      colUnitPrice: 'Unit price',
      colAmount: 'Amount',
      itemDesc: 'Service or article',
      qty: 'Qty',
      amount: '0.00',
      subtotal: 'Subtotal (net)',
      vat: 'VAT 19 %',
      total: 'Total',
      paymentBefore: 'Payable without deduction by ',
      paymentAfter: ' to the account below.',
    ...
    minutes: {
      ...
      description: 'Minutes with a facts table (date, place, participants) and numbered agenda items with decision and action lines.',
      title: 'Minutes: ',
      topic: 'Meeting topic',
      dateLabel: 'Date',
      place: 'Place',
      time: 'Start / end',
      timeValue: 'Time from – to',
      participants: 'Participants',
      participantNames: 'Names',
      recorder: 'Minutes taken by',
      recorderName: 'Name',
      item: 'Item',
      itemTopic: 'Topic',
      discussion: 'Discussion summary',
      decision: 'Decision: ',
      decisionText: 'Decision wording',
      action: 'Action: ',
      actionTask: 'Task',
  ...
  revisions: {
    ...
    display: 'Display for review',
    displayAll: 'All markup',
    displayAllHint: 'Every change and comment',
    displaySimple: 'Simple markup',
    displaySimpleHint: 'Final text with change bars',
    displayNone: 'No markup',
    displayNoneHint: 'The text as it would read',
    displayOriginal: 'Original',
    displayOriginalHint: 'The text before the changes',
    placeBalloons: 'In balloons',
    placePane: 'In the pane',
    prev: 'Previous',
    next: 'Next',
    ...
    pane: 'Revisions',
    showPane: 'Show revisions',
    showPaneHint: 'Show the list of recorded changes',
  ...
  ribbon: {
    ...
    startsOnOdd: 'Start on a right page',
    startsOnEven: 'Start on a left page',
    startsOnHint: 'Take a blank page where the flow would open this section on the other side',
  ...
  app: {
    ...
    template: 'Template',
    templateHint: 'as the document: .ott or .dotx — opens as a new document',
