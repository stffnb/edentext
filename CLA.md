...
- **"Contribution"** means any original work of authorship — including any
  ...
  the project for inclusion in, or documentation of, the software.

## 2. Copyright stays with You

You retain all right, title, and interest in and to Your Contributions. This
agreement does **not** transfer ownership of Your copyright; it only grants the
licenses below.
...
**Right to re-license (dual licensing).** You expressly agree that the Maintainer
may license and distribute Your Contributions, and any derivative works, under
**any license terms**, including:

- the GNU Affero General Public License v3.0 (or any later version), and
- one or more **separate commercial / proprietary licenses**.

This is what allows the project to remain open source under the AGPL while also
...
by You that are necessarily infringed by Your Contribution alone or by combination
of Your Contribution with the project. If any entity institutes patent litigation
alleging that Your Contribution, or the project to which You contributed,
constitutes direct or contributory patent infringement, then any patent licenses
granted to that entity under this agreement for that Contribution terminate.

## 5. Your representations

You represent that:

1. Each Contribution is an original creation by You, **or** You have the necessary
   rights to submit it under the terms of this agreement.
2. Your Contribution does not, to the best of Your knowledge, violate any third
...
3. If Your employer has rights to intellectual property You create, You have
   ...
   Your employer has waived such rights for the Contribution.
4. If any part of Your Contribution is **not** Your original work, You have
   clearly identified it (e.g. its source and license) in Your submission.

## 6. No obligation

You understand that the decision to include Your Contribution in the project is at
the sole discretion of the Maintainer, and this agreement does not obligate the
